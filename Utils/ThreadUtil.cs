...
namespace RFRocketLibrary.Utils
{
    ...
    public static class ThreadUtil
    {
        ...
        public static async Task<T?> RunOnGameThreadAsync<T, TA, TB>(FuncPattern<T, TA, TB> action, TA arg1, TB arg2)
        {
            var callback = new TaskCompletionSource<Exception?>();
            var argue = default(T);
            TaskDispatcher.QueueOnMainThread(() =>
        ...
        public static void QueueOnThreadPool<TA, TB, TC, TD, TE>(TaskPattern<TA, TB, TC, TD, TE> task, TA arg1, TB arg2,
        ...
        public static void QueueOnThreadPool<TA, TB, TC, TD, TE>(VoidPattern<TA, TB, TC, TD, TE> task, TA arg1, TB arg2,
            TC arg3, TD arg4, TE arg5)
        {
